package com.softrice.systrace.transform

import com.android.build.api.transform.*
import com.android.build.gradle.internal.pipeline.TransformTask
import com.softrice.systrace.Log
import com.softrice.systrace.TraceBuildConfig
import com.softrice.systrace.Util
import com.softrice.systrace.retrace.MappingReader
...
public class SystemTraceTransform extends BaseProxyTransform {
    ...
    public void transform(TransformInvocation transformInvocation) throws TransformException, InterruptedException, IOException {
        ...
        final com.softrice.systrace.retrace.MappingCollector mappingCollector = new com.softrice.systrace.retrace.MappingCollector()
        ...
        com.softrice.systrace.MethodCollector methodCollector = new com.softrice.systrace.MethodCollector(traceConfig, mappingCollector)
        HashMap<String, com.softrice.systrace.item.TraceMethod> collectedMethodMap = methodCollector.collect(scrInputMap.keySet().toList(), jarInputMap.keySet().toList())
        com.softrice.systrace.MethodTracer methodTracer = new com.softrice.systrace.MethodTracer(traceConfig, collectedMethodMap, methodCollector.getCollectedClassExtendMap())
